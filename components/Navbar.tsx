...
export default function Navbar() {
  ...
  const isAdsActive = pathname.startsWith("/services/ads");
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-5 md:px-8">
        <div className="flex items-center justify-between h-[60px]">
          ...
          <div className="hidden md:flex items-center gap-0.5">
            ...
            {/* บริการยิง Ads dropdown */}
            <div className="relative" ref={dropdownRef}>
              <button
                className="flex items-center gap-1 px-3.5 py-2 rounded-lg text-sm transition-colors"
                style={{
                  color: isAdsActive ? "#005d90" : "#3e4850",
                  fontWeight: isAdsActive ? 300 : 200,
                  backgroundColor: isAdsActive ? "rgba(0,93,144,0.07)" : "transparent",
                  cursor: "pointer",
                  border: "none",
                  background: isAdsActive ? "rgba(0,93,144,0.07)" : "transparent",
                }}
              ...
              {servicesOpen && (
                ...
                >
                  ...
                  >
                    <span aria-hidden="true" className="material-symbols-outlined" style={{ fontSize: 14 }}>grid_view</span>
                    ภาพรวม บริการยิง Ads ทั้งหมด
                  </Link>
                  ...
                  {adsLinks.map((svc) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          <span aria-hidden="true" className="material-symbols-outlined" style={{ color: svc.color, fontSize: 18 }}>{svc.icon}</span>
                        </div>
                        <div>
          ...
          <div className="flex items-center gap-3">
            ...
            >
              รับแผนกลยุทธ์
              <span aria-hidden="true" className="material-symbols-outlined" style={{ fontSize: 15 }}>arrow_forward</span>
            </Link>
      ...
      >
        <div className="max-w-7xl mx-auto px-8 flex items-center justify-between h-9">
          ...
          >
            <span aria-hidden="true" className="material-symbols-outlined" style={{ fontSize: 14, color: "#00aeef" }}>emoji_events</span>
          ...
          <div className="flex items-center gap-4">
            <a
              ...
              style={{ color: "#3e4850", fontWeight: 200, textDecoration: "none" }}
            >
              <span aria-hidden="true" className="material-symbols-outlined" style={{ fontSize: 13, color: "#3e4850" }}>call</span>
              095-289-9881
            </a>
            ...
            >
              <span aria-hidden="true" className="material-symbols-outlined" style={{ fontSize: 13 }}>chat</span>
              แชทผ่านไลน์
            </a>
      ...
      {open && (
        <div className="md:hidden border-t border-black/5 bg-white px-5 py-4 flex flex-col gap-1">
          ...
          <div className="flex flex-col gap-3 pt-4 mt-2 border-t border-black/5">
            ...
            >
              <span aria-hidden="true" className="material-symbols-outlined" style={{ fontSize: 17 }}>chat</span>
              แชทผ่านไลน์
            </a>
            <Link
              href="/contact"
