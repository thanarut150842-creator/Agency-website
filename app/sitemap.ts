...
const base = process.env.NEXT_PUBLIC_SITE_URL ?? "https://surfdigitalth.com";
...
/**
 * Static "last meaningful update" date — bump เมื่อแก้ content จริงๆ
 * (อย่าใช้ new Date() เพราะจะทำให้ Google เห็นทุกหน้า "เปลี่ยนตลอดเวลา"
 *  ซึ่งทำให้ crawl budget waste และ Google ไม่เชื่อ lastmod)
 */
const SITE_LAST_UPDATE = new Date("2026-05-12");
