...
const tiktokAdsSchema = {
  "@context": "https://schema.org",
  "@type": "Service",
  name: "บริการรับทำ TikTok Ads ภาคใต้",
  serviceType: "TikTok Ads (Spark Ads, In-Feed, Top View)",
  ...
  description: "รับทำโฆษณา TikTok Ads ครบวงจร ตั้งแต่ Spark Ads, In-Feed, TopView สำหรับ Brand และ Performance",
};

const wrap = "w-full max-w-7xl mx-auto px-4 md:px-8";

export const metadata = {
  title: "รับทำ TikTok Ads ภาคใต้ ภูเก็ต กระบี่ สงขลา | Surf Digital Agency",
  description:
    "รับทำ TikTok Ads ภูเก็ต กระบี่ สงขลา เจาะ Gen Z + Millennials ด้วย Creative วิดีโอที่ Viral วัดผลได้",
  alternates: {
...
export default function TikTokAdsPage() {
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(tiktokAdsSchema) }} />
      <SchemaBreadcrumb items={[
        { name: "หน้าแรก", url: "/" },
        { name: "บริการ", url: "/services" },
        { name: "โฆษณาออนไลน์", url: "/services/ads" },
        { name: "TikTok Ads", url: "/services/ads/tiktok-ads" },
      ]} />
      <Navbar />
      <main>
        {/* ── Hero ─────────────────────────────────────────────── */}
          ...
          <div className={`${wrap} relative z-10`}>
            ...
            >
              ...
              <span className="text-xs tracking-widest uppercase" style={{ color: "#2d476f", fontWeight: 300 }}>
                TikTok Ads Agency · ภูเก็ต | กระบี่ | สงขลา
              </span>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <p className="text-lg text-[#3e4850] mb-8 thai-leading" style={{ fontWeight: 200, maxWidth: "34rem", lineHeight: 1.85 }}>
                  ...
                  ธุรกิจในภูเก็ต กระบี่ และสงขลาที่ต้องการเข้าถึงกลุ่มอายุ 18–35 ปี
                ...
                <div className="flex flex-wrap gap-4 mb-10">
                  ...
                  >
                    ...
                    <span aria-hidden="true" className="material-symbols-outlined" style={{ fontSize: 18 }}>music_video</span>
                  </Link>
                  <Link
                    href="/contact"
              ...
              <div className="flex flex-col gap-5">
                ...
                <div className="flex items-center gap-3">
                  <div className="flex items-center gap-2.5 px-4 py-2 rounded-full" style={{ backgroundColor: "#fff", boxShadow: "0 4px 16px rgba(0,0,0,0.10)" }}>
                    <Image src="/pic/TikTok_logo.svg.png" alt="TikTok" width={24} height={24} style={{ objectFit: "contain" }} />
                    <span style={{ fontSize: 14, fontWeight: 400, color: "#010101" }}>TikTok</span>
                    <span style={{ fontSize: 14, fontWeight: 400, color: "#fe2c55" }}>Ads</span>
                  </div>
                  <span className="text-xs px-3 py-1 rounded-full" style={{ backgroundColor: "rgba(254,44,85,0.10)", color: "#fe2c55", fontWeight: 300 }}>● For Business</span>
                </div>
                ...
                <style>{`
                  @keyframes tt-vid1 {
                    ...
                    75%     { transform: translateY(-105%); opacity: 1; }
                    76%,100%{ transform: translateY(-105%); opacity: 0; }
                  }
                  @keyframes tt-vid2 {
                    0%,65%  { transform: translateY(105%); opacity: 0; }
                    66%     { transform: translateY(105%); opacity: 1; }
                  ...
                  @keyframes tt-heart-pop {
                    0%,40%  { transform: scale(1);   color: white; }
                    50%     { transform: scale(1.5); color: #fe2c55; }
                    60%,100%{ transform: scale(1);   color: #fe2c55; }
                  }
                  @keyframes tt-float-heart {
                    0%   { opacity: 1; transform: translateY(0) scale(1) rotate(-10deg); }
                    100% { opacity: 0; transform: translateY(-80px) scale(0.5) rotate(10deg); }
                  }
                  @keyframes tt-ticker {
                    0%,100% { transform: translateX(0); }
                    50%     { transform: translateX(-40px); }
                  }
                  @keyframes tt-glow-ring {
                    0%,100% { box-shadow: 0 0 0 0 rgba(254,44,85,0.6); }
                  ...
                  .tt-vid1 { animation: tt-vid1 5s cubic-bezier(.77,0,.18,1) infinite; }
                  .tt-vid2 { animation: tt-vid2 5s cubic-bezier(.77,0,.18,1) infinite; }
                  .tt-bar  { animation: tt-progress 5s linear infinite; }
                  .tt-disc { animation: tt-disc 3s linear infinite; }
                  .tt-heart-icon { animation: tt-heart-pop 5s ease-in-out infinite; display:inline-block; }
                  .tt-fh1  { animation: tt-float-heart 1.8s ease-out infinite; animation-delay: 1s; }
                  .tt-fh2  { animation: tt-float-heart 1.8s ease-out infinite; animation-delay: 2.2s; }
                  .tt-fh3  { animation: tt-float-heart 1.8s ease-out infinite; animation-delay: 3.4s; }
                  .tt-ticker { animation: tt-ticker 8s linear infinite; white-space: nowrap; }
                  .tt-ctr-badge { animation: tt-glow-ring 2s ease-in-out infinite; }
                `}</style>

                <div className="relative flex justify-center" style={{ paddingBottom: "1rem" }}>

                  {/* Ambient glow */}
                  <div className="absolute inset-0 pointer-events-none" style={{ background: "radial-gradient(ellipse at 50% 60%, rgba(254,44,85,0.18) 0%, transparent 70%)", filter: "blur(20px)" }} />

                  {/* CTR floating badge */}
                  <div className="tt-ctr-badge absolute z-20 px-3 py-1.5 rounded-full text-white text-xs font-bold" style={{ top: "10px", right: "-10px", backgroundColor: "#fe2c55", fontWeight: 700 }}>
                    CTR 3.2% ↑
                  </div>

                  {/* Reach floating badge */}
                  <div className="absolute z-20 px-3 py-1.5 rounded-full text-xs" style={{ top: "52px", right: "-14px", backgroundColor: "#fff", color: "#191c1e", fontWeight: 300, boxShadow: "0 4px 16px rgba(0,0,0,0.15)" }}>
                    👁 1.2M reach
                  </div>
                  ...
                  <div className="relative overflow-hidden" style={{
                    ...
                    {/* Progress bar */}
                    <div className="absolute top-0 left-0 right-0 z-30" style={{ height: 2, backgroundColor: "rgba(255,255,255,0.1)" }}>
                      <div className="tt-bar h-full" style={{ backgroundColor: "#fe2c55" }} />
                    </div>

                    {/* Status bar */}
                    <div className="absolute top-0 left-0 right-0 z-20 flex items-center justify-between px-4" style={{ paddingTop: 6, paddingBottom: 2 }}>
                      <span style={{ fontSize: 9, color: "rgba(255,255,255,0.85)", fontWeight: 600 }}>9:41</span>
                      <div className="flex items-center gap-1">
                        <span style={{ fontSize: 9, color: "rgba(255,255,255,0.85)" }}>●●●</span>
                        <span style={{ fontSize: 9, color: "rgba(255,255,255,0.85)" }}>WiFi</span>
                        <span style={{ fontSize: 9, color: "rgba(255,255,255,0.85)" }}>🔋</span>
                      </div>
                    </div>

                    {/* Top nav */}
                    <div className="absolute z-20 flex items-center justify-center gap-4 left-0 right-0" style={{ top: 18 }}>
                      <span style={{ fontSize: 11, color: "rgba(255,255,255,0.45)", fontWeight: 300 }}>Following</span>
                      <div className="flex flex-col items-center gap-0.5">
                        <span style={{ fontSize: 11, color: "#fff", fontWeight: 700 }}>For You</span>
                        <div style={{ width: 20, height: 2, backgroundColor: "#fff", borderRadius: 1 }} />
                      </div>
                      <span aria-hidden="true" className="material-symbols-outlined" style={{ fontSize: 16, color: "rgba(255,255,255,0.6)" }}>search</span>
                    </div>
                    ...
                    <div style={{ position: "absolute", inset: 0, overflow: "hidden" }}>
                      ...
                      {/* Video 1 */}
                      <div className="tt-vid1 absolute inset-0" style={{ background: "linear-gradient(160deg,#2d1b69 0%,#0f3460 40%,#16213e 100%)" }}>
                        <div className="absolute inset-0" style={{ background: "radial-gradient(circle at 30% 40%, rgba(254,44,85,0.25) 0%, transparent 60%)" }} />
                        <div className="absolute inset-0 flex items-center justify-center">
                          <div style={{ textAlign: "center" }}>
                            <p style={{ fontSize: 28, fontWeight: 800, color: "white", lineHeight: 1.1 }}>ROI</p>
                            <p style={{ fontSize: 36, fontWeight: 800, color: "#fe2c55", lineHeight: 1.1 }}>x6.4</p>
                            <p style={{ fontSize: 9, color: "rgba(255,255,255,0.6)", marginTop: 4 }}>Google Ads · ภูเก็ต</p>
                          </div>
                        </div>
                      </div>

                      {/* Video 2 */}
                      <div className="tt-vid2 absolute inset-0" style={{ background: "linear-gradient(160deg,#0d2137 0%,#1a1a2e 40%,#16213e 100%)" }}>
                        <div className="absolute inset-0" style={{ background: "radial-gradient(circle at 70% 30%, rgba(105,201,208,0.2) 0%, transparent 60%)" }} />
                        <div className="absolute inset-0 flex items-center justify-center">
                          <div style={{ textAlign: "center" }}>
                            <p style={{ fontSize: 11, color: "rgba(255,255,255,0.6)", marginBottom: 4 }}>Meta Ads · กระบี่</p>
                            <p style={{ fontSize: 28, fontWeight: 800, color: "white", lineHeight: 1.1 }}>Lead</p>
                            <p style={{ fontSize: 36, fontWeight: 800, color: "#69c9d0", lineHeight: 1.1 }}>+120%</p>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    {/* Floating hearts */}
                    <div className="tt-fh1 absolute z-20 pointer-events-none" style={{ bottom: 90, right: 28, fontSize: 16 }}>❤️</div>
                    <div className="tt-fh2 absolute z-20 pointer-events-none" style={{ bottom: 90, right: 36, fontSize: 12 }}>❤️</div>
                    <div className="tt-fh3 absolute z-20 pointer-events-none" style={{ bottom: 90, right: 22, fontSize: 10 }}>❤️</div>

                    {/* Bottom overlay */}
                    <div className="absolute bottom-0 left-0 right-0 z-10" style={{ background: "linear-gradient(to top, rgba(0,0,0,0.85) 0%, transparent 100%)", height: "55%" }} />

                    {/* Caption + music ticker */}
                    <div className="absolute z-20 left-3 right-12" style={{ bottom: 36 }}>
                      <p style={{ fontSize: 10, color: "white", fontWeight: 700, marginBottom: 2 }}>@apdigital_th</p>
                      <p style={{ fontSize: 9, color: "rgba(255,255,255,0.8)", lineHeight: 1.4, marginBottom: 6 }}>ยิง Ads ROI x5 🔥 #DigitalMarketing #ภาคใต้</p>
                      <div className="flex items-center gap-1.5 overflow-hidden" style={{ width: "100%" }}>
                        <span style={{ fontSize: 9, color: "rgba(255,255,255,0.6)" }}>♪</span>
                        <div style={{ overflow: "hidden", flex: 1 }}>
                          <span className="tt-ticker" style={{ fontSize: 9, color: "rgba(255,255,255,0.6)", display: "inline-block" }}>
                            Original Sound · Surf Digital Agency · ภาคใต้ Digital Marketing
                          </span>
                        </div>
                      </div>
                    </div>
                    ...
                    {/* Right sidebar */}
                    <div className="absolute z-20 flex flex-col items-center gap-4" style={{ right: 6, bottom: 40 }}>
                      {/* Avatar */}
                      <div style={{ width: 28, height: 28, borderRadius: "50%", background: "linear-gradient(135deg,#fe2c55,#ff6b35)", border: "2px solid white", display: "flex", alignItems: "center", justifyContent: "center" }}>
                        <span style={{ fontSize: 9, color: "white", fontWeight: 700 }}>AP</span>
                      </div>
                      {/* Heart */}
                      <div className="flex flex-col items-center gap-0.5">
                        <span className="tt-heart-icon material-symbols-outlined" style={{ fontSize: 22, color: "#fe2c55" }}>favorite</span>
                        <span style={{ fontSize: 8, color: "white", fontWeight: 700 }}>48.2K</span>
                      </div>
                      {/* Comment */}
                      <div className="flex flex-col items-center gap-0.5">
                        <span aria-hidden="true" className="material-symbols-outlined" style={{ fontSize: 22, color: "white" }}>chat_bubble</span>
                        <span style={{ fontSize: 8, color: "white", fontWeight: 700 }}>3.1K</span>
                      </div>
                      {/* Share */}
                      <div className="flex flex-col items-center gap-0.5">
                        <span aria-hidden="true" className="material-symbols-outlined" style={{ fontSize: 22, color: "white" }}>share</span>
                        <span style={{ fontSize: 8, color: "white", fontWeight: 700 }}>8.4K</span>
                      </div>
                      {/* Music disc */}
                      <div className="tt-disc flex items-center justify-center" style={{ width: 26, height: 26, borderRadius: "50%", background: "linear-gradient(135deg,#fe2c55,#2d1b69)", border: "2px solid rgba(255,255,255,0.3)" }}>
                        <div style={{ width: 8, height: 8, borderRadius: "50%", backgroundColor: "#0f0f0f" }} />
                      </div>
                    </div>

                    {/* Bottom nav */}
                    <div className="absolute bottom-0 left-0 right-0 z-20 flex items-center justify-around py-2" style={{ backgroundColor: "rgba(0,0,0,0.6)", backdropFilter: "blur(8px)" }}>
                      {["home","explore","add_circle","notifications","person"].map((ic, i) => (
                        <span key={ic} className="material-symbols-outlined" style={{ fontSize: i === 2 ? 26 : 18, color: i === 0 ? "white" : "rgba(255,255,255,0.4)" }}>{ic}</span>
                      ))}
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  {kpis.slice(0, 2).map((k) => (
                    <div key={k.label} className="p-5 flex flex-col gap-1.5" style={{ backgroundColor: "#ffffff", borderRadius: "1.25rem", boxShadow: "0 4px 24px rgba(0,0,0,0.06)" }}>
                      <p className="text-2xl" style={{ fontWeight: 400, color: colorAccent }}>{k.value}</p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
              <div>
                ...
                <p className="text-lg text-[#3e4850] mb-5 thai-leading" style={{ fontWeight: 200, lineHeight: 1.85 }}>
                  ...
                  ธุรกิจในภูเก็ต กระบี่ และสงขลาที่ต้องการเข้าถึงคนรุ่นใหม่
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {features.map((f) => (
                ...
                >
                  ...
                  >
                    <span aria-hidden="true" className="material-symbols-outlined" style={{ color: colorAccent, fontSize: 24 }}>{f.icon}</span>
                  </div>
          ...
          <div className={wrap}>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
              <div>
                ...
                <h2 className="text-4xl mb-6 thai-leading" style={{ fontWeight: 400, color: "#191c1e", lineHeight: 1.3 }}>
                  กระบวนการทำ TikTok Ads<br />ของ Surf Digital
                </h2>
          ...
          <div className={wrap}>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                ...
                style={{ backgroundColor: "#f2f4f6", textDecoration: "none" }}
              >
                <span aria-hidden="true" className="material-symbols-outlined" style={{ color: "#0081FB", fontSize: 28 }}>thumb_up</span>
                <div>
            ...
            >
              ...
              <div className="relative z-10" style={{ maxWidth: "44rem", margin: "0 auto" }}>
                ...
                <p className="text-xl mb-10 thai-leading" style={{ fontWeight: 200, opacity: 0.85 }}>
                  ให้ทีม TikTok Ads ของ Surf Digital วิเคราะห์ Content Strategy และ Ad Account ของคุณฟรี
