...
const googleAdsSchema = {
  ...
  "@type": "Service",
  name: "บริการรับทำ Google Ads ภาคใต้",
  serviceType: "Google Ads (Search, Display, Shopping, YouTube)",
  ...
  description: "รับทำ Google Ads แบบ Performance-driven Search, Display, Shopping, YouTube",
};

const wrap = "w-full max-w-7xl mx-auto px-4 md:px-8";

export const metadata = {
  title: "รับทำ Google Ads ภาคใต้ ภูเก็ต กระบี่ สงขลา | Surf Digital Agency",
  description:
    "รับทำ Google Ads ภูเก็ต กระบี่ สงขลา วางแผน Keyword + Ad Copy + Optimize Real-time เพื่อ ROAS สูงสุด ปรึกษาฟรี",
  alternates: {
...
const features = [
  ...
  { icon: "map", title: "Google Maps / Local Ads", desc: "เหมาะสำหรับธุรกิจ Local ในภูเก็ต กระบี่ สงขลา ให้ลูกค้าในพื้นที่ค้นหาเจอธุรกิจของคุณบน Google Maps ก่อนคู่แข่ง" },
];
  ...
  return (
    <>
      ...
      <SchemaBreadcrumb items={[
        ...
        { name: "Google Ads", url: "/services/ads/google-ads" },
      ]} />
      <Navbar />
      <main>
        {/* ── Hero ─────────────────────────────────────────────── */}
          ...
          <div className={`${wrap} relative z-10`}>
            ...
            >
              ...
              <span className="text-xs tracking-widest uppercase" style={{ color: "#2d476f", fontWeight: 300 }}>
                Google Ads Agency · ภูเก็ต | กระบี่ | สงขลา
              </span>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <p className="text-lg text-[#3e4850] mb-8 thai-leading" style={{ fontWeight: 200, maxWidth: "34rem", lineHeight: 1.85 }}>
                  ...
                  หรือลูกค้าในสงขลาที่ต้องการบริการของคุณในทันที
                </p>
                <div className="flex flex-wrap gap-4 mb-10">
                  ...
                  >
                    ...
                    <span aria-hidden="true" className="material-symbols-outlined" style={{ fontSize: 18 }}>ads_click</span>
                  </Link>
                  <Link
                    href="/contact"
              ...
              {/* Right: Google Ads visual */}
              <div style={{ position: "relative", display: "flex", flexDirection: "column", gap: 16 }}>
                <style>{`
                  @keyframes ga-ad-in { from { opacity: 0; transform: translateY(-8px); } to { opacity: 1; transform: translateY(0); } }
                  @keyframes ga-click { 0%,100% { opacity: 1; } 45%,55% { opacity: 0; } }
                  @keyframes ga-badge-glow { 0%,100% { box-shadow: 0 8px 24px rgba(66,133,244,0.35); } 50% { box-shadow: 0 14px 40px rgba(66,133,244,0.70); } }
                  @keyframes ga-float { 0%,100% { transform: translateY(0); } 50% { transform: translateY(-6px); } }
                  @keyframes ga-kpi-pulse { 0%,100% { transform: scale(1); } 50% { transform: scale(1.03); } }
                  @keyframes ga-dot { 0%,100% { opacity: 1; } 50% { opacity: 0.3; } }
                `}</style>

                {/* Ambient glow */}
                <div style={{ position: "absolute", inset: "-28px", background: "radial-gradient(ellipse at 60% 30%, rgba(66,133,244,0.14) 0%, transparent 65%)", pointerEvents: "none", borderRadius: "2rem" }} />

                {/* Logo + badge */}
                <div style={{ position: "relative", display: "flex", alignItems: "center", gap: 12 }}>
                  <Image src="/pic/Google_Ads_logo.svg.png" alt="Google Ads" width={140} height={40} style={{ objectFit: "contain" }} />
                  <span style={{ fontSize: 11, padding: "4px 10px", borderRadius: 20, backgroundColor: "rgba(52,168,83,0.12)", color: "#34a853", fontWeight: 300 }}>● Certified Partner</span>
                </div>

                {/* Enhanced SERP Mockup */}
                <div style={{ position: "relative", backgroundColor: "#ffffff", borderRadius: "1.5rem", boxShadow: "0 20px 60px rgba(0,0,0,0.10)", overflow: "hidden" }}>
                  {/* Browser chrome */}
                  <div style={{ display: "flex", alignItems: "center", gap: 8, padding: "10px 14px", backgroundColor: "#f1f3f4" }}>
                    ...
                    <div style={{ flex: 1, display: "flex", alignItems: "center", gap: 5, backgroundColor: "#fff", borderRadius: 20, padding: "4px 10px" }}>
                      <span aria-hidden="true" className="material-symbols-outlined" style={{ fontSize: 12, color: "#4285F4" }}>search</span>
                      <span style={{ fontSize: 10, color: "#5f6368" }}>โรงแรมภูเก็ต ราคาดี ใกล้ทะเล</span>
                    </div>
                    <span style={{ fontSize: 9, padding: "2px 7px", borderRadius: 10, backgroundColor: "rgba(66,133,244,0.1)", color: "#4285F4", fontWeight: 600, whiteSpace: "nowrap", animation: "ga-dot 1.8s ease infinite" }}>⚡ Live</span>
                  </div>

                  <div style={{ padding: "12px 14px 14px" }}>
                    <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 8 }}>
                      <p style={{ fontSize: 10, color: "#5f6368", fontWeight: 200 }}>Sponsored</p>
                      <span style={{ fontSize: 9, padding: "2px 7px", borderRadius: 10, backgroundColor: "rgba(52,168,83,0.12)", color: "#34a853", fontWeight: 600 }}>🏆 Bid Won</span>
                    </div>

                    {/* #1 Ad – animated slide in */}
                    <div style={{ borderRadius: "0.75rem", padding: "10px 12px", marginBottom: 8, border: "1px solid rgba(66,133,244,0.22)", backgroundColor: "rgba(66,133,244,0.04)", animation: "ga-ad-in 0.7s ease both" }}>
                      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                        <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 3 }}>
                          <span style={{ padding: "1px 5px", borderRadius: 3, color: "#fff", fontSize: 8, fontWeight: 700, backgroundColor: "#4285F4", lineHeight: "15px" }}>Ad</span>
                          <span style={{ fontSize: 10, color: "#188038" }}>apdigital.co.th/google-ads</span>
                        </div>
                        <span style={{ fontSize: 9, color: "#4285F4", animation: "ga-click 2.2s ease infinite" }}>👆 Clicked!</span>
                      </div>
                      <p style={{ fontSize: 13, color: "#1558d6", fontWeight: 700, lineHeight: 1.4 }}>รับทำ Google Ads ภูเก็ต กระบี่ สงขลา | Surf Digital</p>
                      <p style={{ fontSize: 10, color: "#4d5156", marginTop: 2 }}>เพิ่มยอดขายด้วย Google Ads วัดผลได้จริง ROAS 6x+ ปรึกษาฟรี</p>
                    </div>

                    {/* Faded organic results */}
                    {["organic result #1 · competitor.co.th", "organic result #2 · another-site.com"].map((r, i) => (
                      <div key={i} style={{ borderRadius: "0.5rem", padding: "6px 10px", marginBottom: 4, backgroundColor: "#f8f9fa", opacity: 0.35 }}>
                        <p style={{ fontSize: 10, color: "#999" }}>{r}</p>
                      </div>
                    ))}
                  </div>
                </div>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
                  {kpis.slice(0, 2).map((k, i) => (
                    <div key={k.label} style={{ padding: "18px", display: "flex", flexDirection: "column", gap: 5, backgroundColor: "#fff", borderRadius: "1.25rem", boxShadow: "0 4px 24px rgba(0,0,0,0.06)", animation: `ga-kpi-pulse ${2.2 + i * 0.4}s ease infinite` }}>
                      <p style={{ fontSize: "1.5rem", fontWeight: 400, color }}>{k.value}</p>
                      <p style={{ fontSize: "0.875rem", color: "#191c1e", fontWeight: 300 }}>{k.label}</p>
                      <p style={{ fontSize: "0.75rem", color: "#6e7881", fontWeight: 200 }}>{k.sub}</p>
                    </div>
                  ))}
                </div>
                ...
                <div style={{
                  ...
                  background: "linear-gradient(135deg,#4285F4,#34a8ff)",
                  color: "#fff", borderRadius: 20, padding: "7px 14px",
                  fontSize: 12, fontWeight: 700,
                  animation: "ga-badge-glow 2s ease infinite",
                }}>
                  ROAS 6.4x ↑
                </div>
                ...
                <div style={{
                  ...
                  fontSize: 11, fontWeight: 600, color: "#34a853",
                  boxShadow: "0 8px 24px rgba(0,0,0,0.10)",
                  animation: "ga-float 3s ease infinite",
                }}>
                  📉 CPC -40%
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
              <div>
                ...
                <p className="text-base text-[#3e4850] mb-8 thai-leading" style={{ fontWeight: 200, lineHeight: 1.85 }}>
                  ...
                  หรือคลินิกในสงขลาที่ต้องการผู้ป่วยใหม่ Google Ads คือตัวเลือกที่ให้ ROI
          ...
          <div className={wrap}>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
              <div>
                ...
                <h2 className="text-4xl mb-6 thai-leading" style={{ fontWeight: 400, color: "#191c1e", lineHeight: 1.3 }}>
                  กระบวนการทำงาน Google Ads<br />ของ Surf Digital
                </h2>
            ...
            >
              ...
              <div className="relative z-10" style={{ maxWidth: "44rem", margin: "0 auto" }}>
                ...
                <p className="text-xl mb-10 thai-leading" style={{ fontWeight: 200, opacity: 0.85 }}>
                  ให้ทีม Google Ads ของ Surf Digital วิเคราะห์ Ad Account ของคุณฟรี
