...
const adsServiceSchema = {
  "@context": "https://schema.org",
  "@type": "Service",
  name: "บริการรับทำโฆษณาออนไลน์ ภาคใต้",
  serviceType: "Paid Advertising (Google Ads, Meta Ads, TikTok Ads)",
  provider: {
    "@type": "Organization",
  ...
  description: "บริการโฆษณาออนไลน์ครบวงจร Google Ads, Meta Ads, TikTok Ads สำหรับธุรกิจภาคใต้",
  hasOfferCatalog: {
    "@type": "OfferCatalog",
    name: "Paid Advertising Services",
    itemListElement: [
      { "@type": "Offer", itemOffered: { "@type": "Service", name: "Google Ads", url: "https://surfdigitalth.com/services/ads/google-ads" } },
      { "@type": "Offer", itemOffered: { "@type": "Service", name: "Meta Ads", url: "https://surfdigitalth.com/services/ads/meta-ads" } },
      { "@type": "Offer", itemOffered: { "@type": "Service", name: "TikTok Ads", url: "https://surfdigitalth.com/services/ads/tiktok-ads" } },
    ],
  },
};
...
export const metadata = {
  title: "รับทำโฆษณา Google Meta TikTok Ads ภาคใต้ | Surf Digital",
  description:
    "รับทำโฆษณาออนไลน์ครบวงจร Google Ads, Meta Ads, TikTok Ads สำหรับธุรกิจในภูเก็ต กระบี่ สงขลา วัดผลได้ทุกบาท",
  alternates: {
...
const platforms = [
  {
    ...
    desc: "Search Ads, Display, Shopping, YouTube และ Performance Max ครบวงจร สำหรับธุรกิจในภูเก็ต กระบี่ สงขลาที่ต้องการ ROAS วัดได้จริง",
    kpis: [
...
const whyItems = [
  ...
  { icon: "location_on", title: "เชี่ยวชาญตลาดภาคใต้", desc: "เราเข้าใจพฤติกรรมผู้บริโภคในภูเก็ต กระบี่ สงขลา และตลาดนักท่องเที่ยวทั้ง Inbound และ Domestic ทำให้ Targeting แม่นกว่า" },
...
export default function AdsPage() {
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(adsServiceSchema) }} />
          ...
          <div className={`${wrap} relative z-10`}>
            ...
            >
              ...
              <span className="text-xs tracking-widest uppercase" style={{ color: "#2d476f", fontWeight: 300 }}>
                Paid Ads Agency · ภูเก็ต | กระบี่ | สงขลา
              </span>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-[#3e4850] mb-10 thai-leading" style={{ fontWeight: 200, maxWidth: "34rem", lineHeight: 1.85 }}>
                  ไม่ว่าธุรกิจของคุณในภูเก็ต กระบี่ หรือสงขลาจะอยู่ในอุตสาหกรรมใด
          ...
          <div className={wrap}>
            <div className="text-center mb-16">
              ...
              <h2 className="text-4xl text-white mb-4" style={{ fontWeight: 400 }}>
                6 เหตุผลที่ธุรกิจภาคใต้<br />ไว้วางใจ Surf Digital
              </h2>
            ...
            >
              ...
              <div className="relative z-10" style={{ maxWidth: "44rem", margin: "0 auto" }}>
                ...
                <p className="text-xl mb-10 thai-leading" style={{ fontWeight: 200, opacity: 0.85 }}>
                  ให้ทีมผู้เชี่ยวชาญ Ads ของ Surf Digital วิเคราะห์ Ad Account ของคุณฟรี
